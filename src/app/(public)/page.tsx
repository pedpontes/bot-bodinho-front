      ...
      >
        <Col xs={24} md={8}>
          ...
          >
            ...
            <Paragraph>
              Comandos intuitivos para reproduzir músicas do YouTube, Spotify e
              outras plataformas.
            </Paragraph>
          </Card>
        </Col>
        ...
        <Col xs={24} md={8}>
          ...
          >
            ...
            <Paragraph>
              Áudio em alta definição com baixa latência para a melhor
              experiência musical.
            </Paragraph>
          </Card>
        </Col>
        ...
        <Col xs={24} md={8}>
          ...
          >
            ...
            <Paragraph>
              Todos podem adicionar músicas à fila e votar nas próximas a serem
              tocadas.
            </Paragraph>
          </Card>
        </Col>
      ...
      >
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} md={12}>
            ...
            >
              <Text code style={{ color: "#00D4AA", fontSize: "16px" }}>
                /play [música]
              </Text>
              <br />
